...
const ping = (destIP, ttl, cb) => {
  ...
  handleUDPlistening(udp4Socket, destIP, timeout, ttl)
  let ICMPsocket = rawSocket.createSocket({
    protocol: rawSocket.Protocol.ICMP
  })
  handleICMPMssage(timeout, ICMPsocket, udp4Socket, ttl, cb)
...
const handleICMPMssage = (timeout, ICMPsocket, udp4Socket, ttl, cb) => {
